...
def add_test(config, is_default = True):
    ...
    def test():
        ...
        c1 = FA2(config = config,
                 ...
                 admin = sp.address("tz1XgcdbGBhHZGPZhPZ8pyBqoro1AWc6LkSC"))
        scenario += c1
...
def environment_config():
    return FA2_config(
        debug_mode = global_parameter("debug_mode", True),
        ...
        readable = global_parameter("readable", False),
        force_layouts = global_parameter("force_layouts", False),
        support_operator = global_parameter("support_operator", False),
